...
const pageNames={forecast:'需求预测',stock:'备货计划',purchase:'采购计划',shipment:'发货计划',purchaseOrder:'采购单',shipmentOrder:'发货单',skuFirstLegCost:'SKU单位头程成本',supplierInventory:'供应商库存'};
